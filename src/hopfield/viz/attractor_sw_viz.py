...
clustering_coefficient = 0.2  # Clustering coefficient of the small-world network
max_hops = 2  # Maximum number of hops to reach neighboring nodes

# Generate random binary memories
memories = np.random.randint(2, size=(num_memories, n))

# Initialize network and train on memories
network = SmallWorldHopfieldNetwork(n, clustering_coefficient, max_hops)
